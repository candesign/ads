...
// stage content:
(lib.samsung_s6_green_320x450 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// Layer 10
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,0,0,3).dr(-149.55,-298.9,299.1,597.8);
	this.shape.setTransform(160,224.9,1.07,0.753);
	...
	this.instance_1.setTransform(125,423);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(195).to({_off:false},0).to({x:160.5,y:380,alpha:1},20).wait(96));
	...
	this.instance_11.setTransform(125,423);
	...
	this.instance_16.setTransform(401.3,59,1.07,0.605,0,0,0,375,100);

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(311));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(159,223.5,322,601.5);
