...
// stage content:
(lib.samsung_s6_green_480x290 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// Layer 10
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,0,0,3).dr(-95.95,-218.45,191.9,436.9);
	this.shape.setTransform(240,145,2.501,0.664);
	...
	this.instance_1.setTransform(284,266);

	this.instance_2 = new lib.samsung_black();
	this.instance_2.setTransform(25.7,26.5,0.945,0.945);

	this.instance_3 = new lib.s6_black();
	this.instance_3.setTransform(23.8,52,0.803,0.803);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(49).to({_off:false},0).to({scaleX:0.87,scaleY:0.87,x:166.5,y:122.7,alpha:1},19).to({_off:true},118).wait(125));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(1).to({_off:false},0).wait(1).to({regY:113.5,y:362.5},0).wait(1).to({y:331.6},0).wait(1).to({y:308.5},0).wait(1).to({y:289.6},0).wait(1).to({y:273.4},0).wait(1).to({y:259.2},0).wait(1).to({y:246.5},0).wait(1).to({y:234.9},0).wait(1).to({y:224.5},0).wait(1).to({y:214.9},0).wait(1).to({y:206},0).wait(1).to({y:197.9},0).wait(1).to({y:190.4},0).wait(1).to({y:183.4},0).wait(1).to({y:177},0).wait(1).to({y:171.1},0).wait(1).to({y:165.6},0).wait(1).to({y:160.7},0).wait(1).to({y:156.1},0).wait(1).to({y:151.9},0).wait(1).to({y:148.2},0).wait(1).to({y:144.8},0).wait(1).to({y:141.9},0).wait(1).to({y:139.3},0).wait(1).to({y:137.1},0).wait(1).to({y:135.3},0).wait(1).to({y:133.9},0).wait(1).to({y:132.8},0).wait(1).to({y:132.2},0).wait(1).to({regY:91.5,y:110,mode:"synched",loop:false},0).to({_off:true},155).wait(125));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(15).to({_off:false},0).wait(1).to({rotation:98.5,x:-14.1,y:160.5},0).wait(1).to({rotation:136.1,x:33.5,y:158.4},0).wait(1).to({rotation:163.6,x:68.3,y:156.9},0).wait(1).to({rotation:185.9,x:96.3,y:155.6},0).wait(1).to({rotation:204.7,x:120.1,y:154.6},0).wait(1).to({rotation:221,x:140.8,y:153.7},0).wait(1).to({rotation:235.5,x:159,y:152.9},0).wait(1).to({rotation:248.4,x:175.4,y:152.2},0).wait(1).to({rotation:260.1,x:190.1,y:151.5},0).wait(1).to({rotation:270.7,x:203.5,y:150.9},0).wait(1).to({rotation:280.3,x:215.7,y:150.4},0).wait(1).to({rotation:289.2,x:226.9,y:149.9},0).wait(1).to({rotation:297.3,x:237.2,y:149.4},0).wait(1).to({rotation:304.7,x:246.6,y:149},0).wait(1).to({rotation:311.6,x:255.2,y:148.6},0).wait(1).to({rotation:317.8,x:263.1,y:148.3},0).wait(1).to({rotation:323.6,x:270.3,y:148},0).wait(1).to({rotation:328.8,x:277,y:147.7},0).wait(1).to({rotation:333.6,x:283.1,y:147.4},0).wait(1).to({rotation:337.9,x:288.5,y:147.1},0).wait(1).to({rotation:341.8,x:293.4,y:147},0).wait(1).to({rotation:345.3,x:297.9,y:146.7},0).wait(1).to({rotation:348.4,x:301.8,y:146.6},0).wait(1).to({rotation:351.2,x:305.2,y:146.4},0).wait(1).to({rotation:353.5,x:308.2,y:146.3},0).wait(1).to({rotation:355.5,x:310.7,y:146.2},0).wait(1).to({rotation:357.1,x:312.7,y:146.1},0).wait(1).to({rotation:358.4,x:314.3,y:146},0).wait(1).to({rotation:359.3,x:315.5},0).wait(1).to({rotation:359.8,x:316.2},0).wait(1).to({rotation:360,x:316.4},0).to({_off:true},140).wait(125));

	// Layer 7
	this.instance_14 = new lib.wavesloop2("synched",0);
	this.instance_14.setTransform(318.6,147.4,1,1,0,0,0,212.1,212.1);
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(46).to({_off:false},0).wait(84).to({x:313.6,y:146.4,startPosition:4},0).to({x:324.5,y:148.4,alpha:0,startPosition:13},9).wait(172));

	// bgr
	this.instance_15 = new lib.bgr();
	this.instance_15.setTransform(600,38.7,1.6,0.387,0,0,0,375,100.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(311));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(239,144,482,601);
