...
// stage content:
(lib.samsung_s6_green_750x400 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// Layer 10
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,0,0,3).dr(-149.95,-301.3,299.9,602.6);
	this.shape.setTransform(375,200,2.501,0.664);
	...
	var mask_graphics_167 = new cjs.Graphics().p("EjokgmfMHRJAAAMAAABM/MnRJAAAg");
	var mask_graphics_168 = new cjs.Graphics().p("EjnygmfMHPlAAAMAAABM/MnPlAAAg");
	var mask_graphics_169 = new cjs.Graphics().p("EjmVgmfMHMrAAAMAAABM/MnMrAAAg");
	var mask_graphics_170 = new cjs.Graphics().p("EjkDgmeMHIHAAAMAAABM9MnIHAAAg");
	var mask_graphics_171 = new cjs.Graphics().p("EjgsgmcMHBZAAAMAAABM5MnBZAAAg");
	var mask_graphics_172 = new cjs.Graphics().p("Ejb2gmbMG3tAAAMAAABM3Mm3tAAAg");
	var mask_graphics_173 = new cjs.Graphics().p("EjU6gmYMGp1AAAMAAABMxMmp1AAAg");
	var mask_graphics_174 = new cjs.Graphics().p("EjKmgmUMGVNAAAMAAABMpMmVNAAAg");
	var mask_graphics_175 = new cjs.Graphics().p("Ei6GgmOMF0NAAAMAAABMdMl0NAAAg");
	var mask_graphics_176 = new cjs.Graphics().p("EicPgmDME4fAAAMAAABMHMk4fAAAg");
	var mask_graphics_177 = new cjs.Graphics().p("Ehzhgl0MDnDAAAMAAABLpMjnDAAAg");
	var mask_graphics_178 = new cjs.Graphics().p("EhblglrMC3LAAAMAAABLXMi3LAAAg");
	var mask_graphics_179 = new cjs.Graphics().p("EhOgglmMCdBAAAMAAABLNMidBAAAg");
	var mask_graphics_180 = new cjs.Graphics().p("EhGfgljMCM/AAAMAAABLHMiM/AAAg");
	var mask_graphics_181 = new cjs.Graphics().p("EhBWglhMCCtAAAMAAABLDMiCtAAAg");
	var mask_graphics_182 = new cjs.Graphics().p("Eg+CglgMB8FAAAMAAABLBMh8FAAAg");
	var mask_graphics_183 = new cjs.Graphics().p("Eg8AglfMB4BAAAMAAABK/Mh4BAAAg");
	var mask_graphics_184 = new cjs.Graphics().p("Eg68glfMB15AAAMAAABK/Mh15AAAg");
	var mask_graphics_185 = new cjs.Graphics().p("Eg6oglfMB1RAAAMAAABK/Mh1RAAAg");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(166).to({graphics:mask_graphics_166,x:-1490.1,y:239.5}).wait(1).to({graphics:mask_graphics_167,x:-1487.5,y:239.5}).wait(1).to({graphics:mask_graphics_168,x:-1479.1,y:239.5}).wait(1).to({graphics:mask_graphics_169,x:-1463.6,y:239.5}).wait(1).to({graphics:mask_graphics_170,x:-1439.1,y:239.5}).wait(1).to({graphics:mask_graphics_171,x:-1403.1,y:239.5}).wait(1).to({graphics:mask_graphics_172,x:-1351.4,y:239.5}).wait(1).to({graphics:mask_graphics_173,x:-1276.9,y:239.6}).wait(1).to({graphics:mask_graphics_174,x:-1166.5,y:239.6}).wait(1).to({graphics:mask_graphics_175,x:-990,y:239.7}).wait(1).to({graphics:mask_graphics_176,x:-670.1,y:239.8}).wait(1).to({graphics:mask_graphics_177,x:-234.3,y:239.9}).wait(1).to({graphics:mask_graphics_178,x:22.1,y:240}).wait(1).to({graphics:mask_graphics_179,x:162.1,y:240}).wait(1).to({graphics:mask_graphics_180,x:247.9,y:240.1}).wait(1).to({graphics:mask_graphics_181,x:303,y:240.1}).wait(1).to({graphics:mask_graphics_182,x:338.5,y:240.1}).wait(1).to({graphics:mask_graphics_183,x:360.2,y:240.1}).wait(1).to({graphics:mask_graphics_184,x:371.6,y:240.1}).wait(1).to({graphics:mask_graphics_185,x:375.3,y:240}).wait(111).to({graphics:mask_graphics_296,x:375,y:300}).wait(1).to({graphics:mask_graphics_297,x:376.5,y:300}).wait(1).to({graphics:mask_graphics_298,x:380.5,y:300}).wait(1).to({graphics:mask_graphics_299,x:386.8,y:300}).wait(1).to({graphics:mask_graphics_300,x:395.1,y:300}).wait(1).to({graphics:mask_graphics_301,x:405.7,y:300}).wait(1).to({graphics:mask_graphics_302,x:418.5,y:300}).wait(1).to({graphics:mask_graphics_303,x:433.8,y:300}).wait(1).to({graphics:mask_graphics_304,x:452.1,y:300}).wait(1).to({graphics:mask_graphics_305,x:473.9,y:300}).wait(1).to({graphics:mask_graphics_306,x:500.3,y:300}).wait(1).to({graphics:mask_graphics_307,x:532.8,y:300}).wait(1).to({graphics:mask_graphics_308,x:574.7,y:300}).wait(1).to({graphics:mask_graphics_309,x:634.4,y:300}).wait(1).to({graphics:mask_graphics_310,x:800.5,y:300}).wait(1));

	// Layer 14
	this.instance_1 = new lib.next_is_now_black();
	this.instance_1.setTransform(542,356.5);

	this.instance_2 = new lib.samsung_black();
	this.instance_2.setTransform(42.4,42,1.166,1.166);

	this.instance_3 = new lib.s6_black();
	this.instance_3.setTransform(40,73.5,0.992,0.992);
	...
	this.instance_4.setTransform(138.5,370.1,1.287,1.287,0,0,0,76.5,25.1);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.instance_4.mask = mask;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(195).to({_off:false},0).to({regX:76.4,scaleX:1.29,scaleY:1.28,x:138.4,y:293.8,alpha:1},20).wait(96));

	// Layer 13
	this.instance_5 = new lib.inch();
	this.instance_5.setTransform(183.4,167,1,1,0,0,0,139,11);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.instance_5.mask = mask;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(184).to({_off:false},0).to({y:114,alpha:1},20).wait(107));

	// Layer 12
	this.instance_6 = new lib.Tween2("synched",0);
	this.instance_6.setTransform(1169,-23.3,1.034,1.036);
	this.instance_6._off = true;

	this.instance_6.mask = mask;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(166).to({_off:false},0).to({x:958.5},7).to({x:796.4},22).wait(116));
	...
	this.instance_8.setTransform(145.5,83.6,1.256,1.256,0,0,0,84,10.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(311));

	// samsun white
	this.instance_9 = new lib.samsungwhite();
	this.instance_9.setTransform(95.4,51.6,1.256,1.256,0,0,0,43.1,6);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(311));

	// next white
	this.instance_10 = new lib.next_is_now();
	this.instance_10.setTransform(542,356.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(311));

	// Layer 8
	this.instance_11 = new lib.text();
	this.instance_11.setTransform(129,140.5,1,1,0,0,0,158,37.5);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(49).to({_off:false},0).to({x:203.7,y:140.7,alpha:1},19).to({_off:true},118).wait(125));

	// phone blank
	this.instance_12 = new lib.bankphone("single",0);
	this.instance_12.setTransform(473,418.5,1,1,0,0,0,56,91.5);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(1).to({_off:false},0).wait(1).to({regY:113.5,x:473.2,y:376.3},0).wait(1).to({x:473.3,y:350.8},0).wait(1).to({x:473.4,y:331.8},0).wait(1).to({x:473.5,y:316.2},0).wait(1).to({y:302.9},0).wait(1).to({x:473.6,y:291.2},0).wait(1).to({y:280.7},0).wait(1).to({y:271.2},0).wait(1).to({x:473.7,y:262.6},0).wait(1).to({y:254.6},0).wait(1).to({y:247.4},0).wait(1).to({y:240.7},0).wait(1).to({x:473.8,y:234.5},0).wait(1).to({y:228.8},0).wait(1).to({y:223.5},0).wait(1).to({y:218.6},0).wait(1).to({y:214.1},0).wait(1).to({x:473.9,y:210},0).wait(1).to({y:206.2},0).wait(1).to({y:202.8},0).wait(1).to({y:199.7},0).wait(1).to({y:197},0).wait(1).to({y:194.5},0).wait(1).to({y:192.4},0).wait(1).to({y:190.6},0).wait(1).to({y:189.1},0).wait(1).to({y:187.9},0).wait(1).to({y:187.1},0).wait(1).to({y:186.6},0).wait(1).to({regY:91.5,x:474,y:164.4,mode:"synched",loop:false},0).to({_off:true},155).wait(125));

	// disc
	this.instance_13 = new lib.disc_1();
	this.instance_13.setTransform(-138.5,200,1,1,0,0,0,70.5,70);
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(15).to({_off:false},0).wait(1).to({rotation:98.5,x:12.4,y:200.1},0).wait(1).to({rotation:136.1,x:70.2},0).wait(1).to({rotation:163.6,x:112.4,y:200.2},0).wait(1).to({rotation:185.9,x:146.4},0).wait(1).to({rotation:204.7,x:175.3},0).wait(1).to({rotation:221,x:200.3},0).wait(1).to({rotation:235.5,x:222.5},0).wait(1).to({rotation:248.4,x:242.3,y:200.3},0).wait(1).to({rotation:260.1,x:260.2},0).wait(1).to({rotation:270.7,x:276.5},0).wait(1).to({rotation:280.3,x:291.3},0).wait(1).to({rotation:289.2,x:304.9,y:200.2},0).wait(1).to({rotation:297.3,x:317.3,y:200.3},0).wait(1).to({rotation:304.7,x:328.7},0).wait(1).to({rotation:311.6,x:339.1},0).wait(1).to({rotation:317.8,x:348.8},0).wait(1).to({rotation:323.6,x:357.5},0).wait(1).to({rotation:328.8,x:365.6},0).wait(1).to({rotation:333.6,x:372.9},0).wait(1).to({rotation:337.9,x:379.6},0).wait(1).to({rotation:341.8,x:385.6},0).wait(1).to({rotation:345.3,x:390.9},0).wait(1).to({rotation:348.4,x:395.7,y:200.4},0).wait(1).to({rotation:351.2,x:399.9,y:200.3},0).wait(1).to({rotation:353.5,x:403.5},0).wait(1).to({rotation:355.5,x:406.5},0).wait(1).to({rotation:357.1,x:409},0).wait(1).to({rotation:358.4,x:410.9},0).wait(1).to({rotation:359.3,x:412.3},0).wait(1).to({rotation:359.8,x:413.1,y:200.4},0).wait(1).to({rotation:360,x:413.4},0).to({_off:true},140).wait(125));

	// Layer 7
	this.instance_14 = new lib.wavesloop2("synched",0);
	this.instance_14.setTransform(413.6,201.4,1,1,0,0,0,212.1,212.1);
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(46).to({_off:false},0).wait(84).to({x:417.6,y:203.4,startPosition:4},0).to({x:413.5,y:200.4,alpha:0,startPosition:13},9).wait(172));

	// bgr
	this.instance_15 = new lib.bgr();
	this.instance_15.setTransform(937.5,53.9,2.5,0.533,0,0,0,375,100);

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(311));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(374,199,752,601);
